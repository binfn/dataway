/// <reference types="https://deno.land/x/xuybin_fresh@v0.0.6/types.d.ts" />
export * from "https://deno.land/x/xuybin_fresh@v0.0.6/runtime.ts";
...
import { IS_BROWSER } from "https://deno.land/x/xuybin_fresh@v0.0.6/runtime.ts";
